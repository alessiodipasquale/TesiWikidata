import os
directory = '/Users/alessiodipasquale/Projects/TesiWikidata/musicalband/cleaned.json'
with open(directory,'r') as file:
    ...
    while w < len(list_of_entities):
        ...
        if x == w:
            ...
            string = ''
        x += 50
    with open('/Users/alessiodipasquale/Projects/TesiWikidata/musicalband/formatted.json','w') as f: #subjectForAPI
        for r in result:
            f.write(r+'\n')
